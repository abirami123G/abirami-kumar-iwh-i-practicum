...
app.get('/', async (req, res) => {
    const contacts = 'https://api.hubspot.com/crm/v3/objects/2-166787136?properties=name,description,toysprice,toysid';
    const headers = {
            ...
            "inputs": [
                {
                    ...
                    "id": req.body.toysid,
                    "properties": {
                        "toysid": req.body.toysid,
                        "name": req.body.name,
                        "description": req.body.description,
                        "toysprice": req.body.toysprice
                    }
                }
            ]
        }

        const response = await axios.post(`https://api.hubspot.com/crm/v3/objects/2-166787136/batch/upsert`, batchContactData,
            {
                headers:
                {
                    'Authorization': `Bearer ${PRIVATE_APP_ACCESS}`,
